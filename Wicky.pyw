...
def export_chatlog():
    ...
    if log =='':
        empty_box = messagebox.showinfo('Empty textbox', 'Nothing to be exported.')
    else:
...
clear_button = CTk.CTkButton(app, text="Clear All", command=clear_all, width=50)
...
export_chatlog_button.place(x=275,y=490)
toggle_theme_button=CTk.CTkButton(app,text='\u2600',width=3,command=toggle_theme)
toggle_theme_button.place(x=385,y=490)
